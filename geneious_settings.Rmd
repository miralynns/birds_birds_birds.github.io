...
This gtf file is created from the blastn.out file. Follow the instructions on this workbook to create the .gft file.
...
Display: Unclick Concensus at the top. In the Translation area, set the Translation on Consensus & Reference. Set the Translation Options Relative to Reference.
