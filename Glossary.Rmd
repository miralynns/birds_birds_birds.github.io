...
**Reference Genome:** A fully sequenced, assembled, and preferrably annotated genome of an individual representative of a specific species, where other genomic data can then be aligned and interpreted against the original or "reference"; the product of de novo assembly 
